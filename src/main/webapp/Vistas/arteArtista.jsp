<%-- 
    Document   : arteArtista
    Created on : 26 jun 2023, 15:53:40
    Author     : conej
--%>
...
<%
    ...
    String artista = (String) request.getSession().getAttribute("artista");
%>
<!DOCTYPE html>
<html>
    <head>
    ...
    <body>
        ...
        <button onclick="window.location.href='<%= request.getContextPath()%>/listarArtistas'">Regresar</button>
    </body>
</html>
